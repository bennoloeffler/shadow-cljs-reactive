...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_26008 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26008(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26010 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26010(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26012 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26012(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26014 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26014(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26016 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26016(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26018 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26018(reader);
}
});
...
var G__26065 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__26066 = s.append(c);
c = G__26065;
s = G__26066;
continue;
}
