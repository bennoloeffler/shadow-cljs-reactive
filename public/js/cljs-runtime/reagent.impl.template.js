...
var G__26378 = o;
goog.object.set(G__26378,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__26411__delegate = function (args){
...
while (G__26412__i < G__26412__a.length) {G__26412__a[G__26412__i] = arguments[G__26412__i + 0]; ++G__26412__i;}
  args = new cljs.core.IndexedSeq(G__26412__a,0,null);
} 
return G__26411__delegate.call(this,args);};
G__26411.cljs$lang$maxFixedArity = 0;
G__26411.cljs$lang$applyTo = (function (arglist__26413){
var args = cljs.core.seq(arglist__26413);
return G__26411__delegate(args);
});
...
var G__26379 = o;
goog.object.set(G__26379,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__26415__i < G__26415__a.length) {G__26415__a[G__26415__i] = arguments[G__26415__i + 0]; ++G__26415__i;}
  args = new cljs.core.IndexedSeq(G__26415__a,0,null);
} 
return G__26414__delegate.call(this,args);};
G__26414.cljs$lang$maxFixedArity = 0;
G__26414.cljs$lang$applyTo = (function (arglist__26416){
...
var G__26380 = props;
var G__26380__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26380,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__26380);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26380__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__26381 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26381,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__26381;
}
})(),id_class);
...
var G__26382 = (cljs.core.count(argv) - first_child);
switch (G__26382) {
case (0):
...
var vec__26383 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26383,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26383,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26383,(2),null);
...
var temp__5739__auto___26418 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___26418 == null)){
} else {
var key_26419 = temp__5739__auto___26418;
(jsprops.key = key_26419);
}
...
var temp__5739__auto___26420 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___26420 == null)){
} else {
var key_26421 = temp__5739__auto___26420;
(jsprops.key = key_26421);
}
...
var temp__5739__auto___26428 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___26428 == null)){
} else {
var key_26429 = temp__5739__auto___26428;
(jsprops.key = key_26429);
}
...
var temp__5739__auto___26430 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___26430 == null)){
} else {
var key_26431 = temp__5739__auto___26430;
(jsprops.key = key_26431);
}
...
var temp__5739__auto___26432 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___26432 == null)){
} else {
var key_26433 = temp__5739__auto___26432;
(jsprops.key = key_26433);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26386_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__26386_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__26387 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26387,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26387,(1),null);
...
break;
default:
var G__26437 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__26438 = compiler;
v = G__26437;
compiler = G__26438;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template26393 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template26393 = (function (opts,id,fn_to_element,meta26394){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template26393.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_26395,meta26394__$1){
var self__ = this;
var _26395__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template26393(self__.opts,self__.id,self__.fn_to_element,meta26394__$1));
}));

(reagent.impl.template.t_reagent$impl$template26393.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_26395){
var self__ = this;
var _26395__$1 = this;
return self__.meta26394;
}));

(reagent.impl.template.t_reagent$impl$template26393.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template26393.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template26393.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template26393.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template26393.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta26394","meta26394",400216876,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template26393.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template26393.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template26393");

(reagent.impl.template.t_reagent$impl$template26393.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template26393");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template26393.
 */
reagent.impl.template.__GT_t_reagent$impl$template26393 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template26393(opts__$1,id__$1,fn_to_element__$1,meta26394){
return (new reagent.impl.template.t_reagent$impl$template26393(opts__$1,id__$1,fn_to_element__$1,meta26394));
});

}

return (new reagent.impl.template.t_reagent$impl$template26393(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
